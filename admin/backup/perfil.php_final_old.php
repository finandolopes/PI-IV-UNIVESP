...
$stmt = mysqli_prepare($conexao, "SELECT * FROM adm WHERE id_usuario = ?");
                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                <label>Usuário</label>
                                <input type="text" placeholder="Insira seu Usuário" value="<?php echo htmlspecialchars($usuario['usuario']); ?>">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="pass-group">
                                    <input type="password" class="pass-input" placeholder="Digite nova senha se quiser alterar">

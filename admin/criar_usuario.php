...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if (criarUsuario($conexao, $nome, $usuario, $senha, $telefone, $email, $perfil)) {
            ...
            header('Location: criar_usuario.php' . ($is_iframe ? '?iframe=1' : ''));
            exit();
        } else {
...
<head>
    ...
    <title>Criar Usuário - CONFINTER</title>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <p class="text-muted">Preencha os dados abaixo para criar um novo usuário no sistema</p>

...
$usuario = null;
$stmt = $conexao->prepare('SELECT id_usuario, nome, usuario, email, perfil as tipo, data_cadastro, avatar FROM adm WHERE usuario = ?');
...
// Estatísticas para os cards (se for admin)
$stats = null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['usuario'] = $email; // Atualizar sessão se email mudou
                    ...
                    <div class='card-body box-profile'>
                        ...
                        <p class='text-muted text-center'>
                            ...
                            if ($usuario['tipo'] === 'admin') {
                                ...
                                echo '<span class="badge badge-info">Analista</span>';
                            }
                            ?>
                        </p>
                        ...
                        <ul class='list-group list-group-unbordered mb-3'>
                            <li class='list-group-item'>
                                <b>Usuário</b> <a class='float-right'><?php echo htmlspecialchars($usuario['usuario']); ?></a>
                            </li>
                            <li class='list-group-item'>
